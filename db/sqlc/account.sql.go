...
WHERE id = $2
RETURNING id, balance, currency, owner, created_at
`
...
func (q *Queries) AddAccountBalance(ctx context.Context, arg AddAccountBalanceParams) (Account, error) {
	row := q.queryRow(ctx, q.addAccountBalanceStmt, addAccountBalance, arg.Balance, arg.ID)
	var i Account
	err := row.Scan(
		&i.ID,
		&i.Balance,
...
SELECT id, balance, currency, owner, created_at FROM accounts
WHERE id = $1 LIMIT 1
`
...
WHERE id = $1 RETURNING id, balance, currency, owner, created_at
`
