...
// Source: github.com/quavo19/bankapi/db/sqlc (interfaces: Store)
//
...
func (m *MockStore) UpdateAccounts(ctx context.Context, arg db.UpdateAccountsParams) (db.Account, error) {
	m.ctrl.T.Helper()
